  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="px-4 py-2 bg-purple-600 text-white rounded-lg shadow-md">Create new</button>
      </div>
      <div className="flex space-x-4">
        ...
        <TaskColumn title="In progress" tasks={[{ id: 2, title: 'Design Home Page UI', priority: 'Medium', date: '2024-08-15', time: '1 hr ago' }, /* more tasks */]} />
        <TaskColumn title="Under review" tasks={[{ id: 3, title: 'Integrate Cloud Storage', priority: 'Urgent', date: '2024-08-20', time: '2 days ago' }, /* more tasks */]} />
        <TaskColumn title="Finished" tasks={[{ id: 4, title: 'Test Cross-browser Compatibility', priority: 'Medium', date: '2024-07-30', time: '4 days ago' }, /* more tasks */]} />
      </div>
    </div>
  );
};
